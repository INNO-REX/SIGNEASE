defmodule SigneaseWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: SigneaseWeb.Gettext
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SigneaseWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SigneaseWeb.Gettext, "errors", msg, opts)
    end
  end
