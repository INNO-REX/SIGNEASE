defmodule SigneaseWeb.Lecturer.Components.TopNavComponent do
            ...
            <div class="relative group" x-data="{ open: false }">
              <button @click="open = !open" @click.away="open = false" class="flex items-center space-x-2 p-2 rounded-lg hover:bg-gray-100 transition-colors">
                ...
                <div class="text-sm text-left">
                  ...
                  <p class="text-gray-500"><%= String.capitalize(@current_user.user_type) %> • <%= String.capitalize(@current_user.sign_language_skills) %></p>
                </div>
